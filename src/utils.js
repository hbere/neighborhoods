...
// export function load_google_place(placeId) {
//     return new Promise(function (resolve, reject) {
//         // define the global callback that will run when google maps is loaded
//         window.resolveGoogleMapsPromise = function () {
//             // resolve the google object
...
//         const script = document.createElement("script");
//         const API_KEY = 'AIzaSyB_Yz-oO8-fDiCRNMBAEgGPbN5jVafGTwA';
//         script.src = `https://maps.googleapis.com/maps/api/geocode/json?placeid=${placeId}&key=${API_KEY}&callback=resolveGooglePlacesPromise`;
//         script.async = true;
//         document.body.appendChild(script);
//     });
// }